...
class GenericFlatblockNode(Node):
    def __init__(self, slug, modelname=None, template_path=None, variable_name=None):
        self.slug = slug
        self.modelname = modelname or '"generic_flatblocks.FlatblockTitleAndText"'
        self.template_path = template_path or '"genericflatblocks/default.html"'
    ...
    def render(self, context):    
        ...
        # Render the template
        try: 
            t = get_template(self.resolve(self.template_path, context))
        except:
...
register.tag('genericflatblock', do_genericflatblock)