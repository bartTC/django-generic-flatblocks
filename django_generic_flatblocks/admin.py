...
class GenericFlatblockAdmin(admin.ModelAdmin):
    ...
    list_display = ('related_object_changelink', 'slug')
    ...
    def change_view(self, request, object_id, form_url='', extra_context=None):
        ...
        c = {
            'admin_url': self.generate_related_object_admin_link(
                related_object
            ),
        ...
        self.change_form_template = (
            'admin/django_generic_flatblocks/change_form_forward.html'
        )
        return super(GenericFlatblockAdmin, self).change_view(
            request, object_id, extra_context=c
        )
